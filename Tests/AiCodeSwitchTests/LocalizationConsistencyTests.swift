...
final class LocalizationConsistencyTests: XCTestCase {
    ...
    private func resourcesRoot() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent() // AiCodeSwitchTests
            .deletingLastPathComponent() // Tests
            .deletingLastPathComponent() // project root
            .appendingPathComponent("Sources/AiCodeSwitch/Resources", isDirectory: true)
    }
    ...
    private func sourceRoot() -> URL {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/AiCodeSwitch", isDirectory: true)
    }
