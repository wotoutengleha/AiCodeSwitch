...
struct AccountTokenCostSummary: Equatable, Sendable {
...
enum CurrentAccountTokenCostState: Equatable, Sendable {
    case idle
    case loading
    case available(AccountTokenCostSummary)
    case unavailable
    case failed(String)
}
...
struct SwitchAccountExecutionResult: Equatable {
    ...
    var openClawSynced: Bool
    var openClawSyncWarning: String?
    var openClawSyncError: String?
    ...
    static let idle = SwitchAccountExecutionResult(
        ...
        openClawSynced: false,
        openClawSyncWarning: nil,
        openClawSyncError: nil,
        restartedEditorApps: [],
        editorRestartError: nil
    )
}

struct OpenClawSwitchExecutionResult: Equatable, Sendable {
    var synced: Bool
    var warning: String?
    var error: String?

    static let notRequested = OpenClawSwitchExecutionResult(synced: false, warning: nil, error: nil)
}
...
struct AppSettings: Codable, Equatable {
    static let supportedAutoRefreshIntervals = [1, 5, 10, 20, 30]

    var launchAtStartup: Bool
    var launchCodexAfterSwitch: Bool
    var syncOpenClawOnSwitch: Bool
    var showEmails: Bool
    ...
    init(
        ...
        syncOpenClawOnSwitch: Bool = false,
        showEmails: Bool,
        ...
        self.syncOpenClawOnSwitch = syncOpenClawOnSwitch
        self.showEmails = showEmails
        self.autoRefreshIntervalMinutes = AppSettings.normalizedAutoRefreshInterval(autoRefreshIntervalMinutes)
    ...
    init(from decoder: Decoder) throws {
        ...
        syncOpenClawOnSwitch = try container.decodeIfPresent(Bool.self, forKey: .syncOpenClawOnSwitch) ?? fallback.syncOpenClawOnSwitch
        showEmails = try container.decodeIfPresent(Bool.self, forKey: .showEmails) ?? fallback.showEmails
        autoRefreshIntervalMinutes = AppSettings.normalizedAutoRefreshInterval(
            try container.decodeIfPresent(Int.self, forKey: .autoRefreshIntervalMinutes) ?? fallback.autoRefreshIntervalMinutes
        )
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(syncOpenClawOnSwitch, forKey: .syncOpenClawOnSwitch)
    ...
    static func normalizedAutoRefreshInterval(_ value: Int) -> Int {
        supportedAutoRefreshIntervals.contains(value) ? value : 5
    }
}
...
struct AppSettingsPatch {
    ...
    var syncOpenClawOnSwitch: Bool? = nil
    var showEmails: Bool? = nil
    var autoRefreshIntervalMinutes: Int? = nil
